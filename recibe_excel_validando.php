...
if( !empty($celular) ){
    $checkemail_duplicidad = ("SELECT celular FROM clientes WHERE celular='".($celular)."' ");
            $ca_dupli = sqlsrv_query($con, $checkemail_duplicidad);
            $cant_duplicidad = sqlsrv_num_rows($ca_dupli);
        }   
...
/**Caso Contrario actualizo el o los Registros ya existentes*/
    ...
    ");
    $result_update = sqlsrv_query($con, $updateData);
    } 
  }
